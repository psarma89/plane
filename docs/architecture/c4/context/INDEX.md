...
Plane as one box. Who uses it, and what it depends on. This level never opens the box.

Read [`../AGENTS.md`](../AGENTS.md) for the shared rules, then [`AGENTS.md`](./AGENTS.md) for the L1 rules. Follow [`TEMPLATE.md`](./TEMPLATE.md).

...
| --- | --- | --- | --- |
| N.2.1 | Only a project admin can change project settings | `apps/api/plane/app/permissions/project.py` (`ProjectAdminPermission`) | [Arch](../architecture/c4/l3-components/NN-slug.md) |
